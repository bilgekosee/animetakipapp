...
<template>
  <main>
    <h1>Anime Takip Uygulamam</h1>

    <form @submit.prevent="searchAnime">
      <input
        type="text"
        placeholder="Anime için arama yapın..."
        v-model="query"
        @input="handleInput"
      />
    ...
    <div class="results" v-if="search_results.length > 0">
      <div v-for="anime in search_results" class="result" v-bind:key="anime.id">
        ...
        <div class="details">
          ...
          <button @click="addAnime(anime)" class="button">Animemi Ekle</button>
        </div>
      </div>
    </div>
